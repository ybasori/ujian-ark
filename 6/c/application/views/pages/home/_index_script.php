    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addData" action="" method="post">
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    <select type="text" class="form-control"  name="work">
                        <option value="" hidden>Work</option>
...
<script>
    (function(){
        ...
        $(".open-modal-edit").on("click", function(){
            ...
            $("#EditData [name='work']").val(work_id);
        ...
        $("#addData").on("submit", function(e){
            if(($(this).find("[name='name']").val()=="") || ($(this).find("[name='work']").val()=="") || ($(this).find("[name='salary']").val()=="")){
                e.preventDefault();
            }
